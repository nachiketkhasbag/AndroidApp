...
import com.example.cooker.ChefActivityFragments.FragmentResetPasswordChef;
import com.example.cooker.Common.FireBaseAuthClass;
...
public class FragmentAccountSettingsGuest extends Fragment {
    ...
    public void setKnownFields(){
        ...
        editTextUpdateGuestEmailAddress.setText(UserInfo.getEmailID());
    }
    ...
    public void UpdateNewFields()
    {
        ...
        mDataBaseRef.child("userProfile").child(UserInfo.getuID()).child("profile").
